...
{
      12,    -9,    -9,     3,    -9,    18,    18,    24,    12,    -2,
      18,    -9,    19,    -9,    -9,    -9,    18,    18,    18,    18,
      26,    -9,    -8,    -8,    -9,    -9
};
...
{
      11,    12,    18,    19,    15,    20,    16,    17,    18,    19,
      10,    22,    23,    24,    25,     1,     2,     3,     4,    14,
       5,     1,     2,     3,    13,     6,     5,    16,    17,    18,
      19,     6,     0,    21,    16,    17,    18,    19
};

static const yytype_int8 yycheck[] =
{
       5,     6,    10,    11,     6,    10,     8,     9,    10,    11,
       7,    16,    17,    18,    19,     3,     4,     5,     6,     8,
       8,     3,     4,     5,     0,    13,     8,     8,     9,    10,
      11,    13,    -1,    14,     8,     9,    10,    11
};
...
#line 60 "calc.y" /* yacc.c:1646  */
    { (yyval.val) = get_var((yyvsp[0].id)); }
#line 1291 "parser.c" /* yacc.c:1646  */
    break;

  case 9:
#line 61 "calc.y" /* yacc.c:1646  */
    { (yyval.val) = (yyvsp[0].val); set_var((yyvsp[-2].id), (yyvsp[0].val)); }
